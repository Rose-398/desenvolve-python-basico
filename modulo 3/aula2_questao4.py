...
if classe=="guerreiro" and força >= 15 and magia <=10:
    print('Ponto de atributo consistente com a classe escolhida: True')
else:
    if classe=="arqueiro" and força and magia >= 5 and força and magia >15:
        print('Ponto de atributo consistente com a classe escolhida: True')
    else:
        if classe=="mago" and força <= 10 and magia >=15:
            print('Ponto de atributo consistente com a classe escolhida: True')
        else:
            print("Ponto de atributo consistente com a classe escolhida: False")